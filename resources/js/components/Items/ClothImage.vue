...
watch(()=>previewImage1.value,(newVal)=>{
  emits('setClothImage1',newVal)
})
watch(()=>previewImage2.value,(newVal)=>{
  emits('setClothImage2',newVal)
})
</script>
      ...
      <div class="flex gap-10">
        ...
        <div class="w-40 mt-5 h-full rounded-md gap-[10px] p-2 shadow-[0px_0px_6.1px_0px_#00000040]">
          <div class="flex items-center justify-between mb-2">
            <h1 class="font-normal text-[14px] leading-[8px] tracking-[0%] text-[#8C8C8C] font-lato block">Cloth 1</h1>
        ...
        <div class="w-40 mt-5 h-full rounded-md gap-[10px] p-2 shadow-[0px_0px_6.1px_0px_#00000040]">
          <div class="flex items-center justify-between mb-2">
            <h1 class="font-normal text-[14px] leading-[8px] tracking-[0%] text-[#8C8C8C] font-lato block">Cloth 2</h1>
